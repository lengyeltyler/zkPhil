...
const STACK_CONFIG = {
  ...
  [MUTABLE_STACK_ACCOUNT_ABSTRACTION]: {
    ...
    configKeys: [
      ...
      'starknetCore',
      'l2UnlockSender',
      'starknetAppBindingManifest',
      'unlockPayloadVersion',
...
function buildCompatibilityFields(stack, components, dependencies, config) {
  ...
  return {
    ...
    starknetAppBindingManifest: config.starknetAppBindingManifest || '',
    unlockPayloadVersion: config.unlockPayloadVersion || '',
    constraintsHashEncoding: config.constraintsHashEncoding || '',
